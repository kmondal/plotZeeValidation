...
Reweighting::Reweighting(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     // a single tree instead of a chain
      ...
      chain->Add("output_mc.root/diphotonDumper/trees/GluGluHtoGG_13TeV_All");
...
Int_t Reweighting::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Reweighting::LoadTree(Long64_t entry)
{
...
void Reweighting::Show(Long64_t entry)
{
...
Int_t Reweighting::Cut(Long64_t entry)
{
